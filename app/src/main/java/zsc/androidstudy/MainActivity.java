...
public class MainActivity extends AppCompatActivity implements ViewPager.OnPageChangeListener, View.OnTouchListener{
    ...
    private void findViews() {
        my=(Button) findViewById(R.id.my1);
        ...
        car=(Button) findViewById(R.id.gouwuche1);
        ...
        item=(Button) findViewById(R.id.item1);
    ...
    private void addImageView(){
        ...
        view0.setImageResource(R.drawable.lunbotu1);
        ImageView view1 = new ImageView(this);
        view1.setImageResource(R.drawable.lunbotu2);
        ImageView view2 = new ImageView(this);
        view2.setImageResource(R.drawable.lunbotu3);
